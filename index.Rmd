...
write.csv(DataTable, file = "DataTableCAHousing.csv", row.names = FALSE)
...
```{r Income growth to house price growth, echo=FALSE, warning=FALSE, message=FALSE, fig.height=6, fig.width=6}
HouseSalaryGrowth <- subset(FilteredDataTable, select = c(County.Name, 
                                                          LaborRatio,
                                                          Income1GrowthRate,
                                                          Income3GrowthRate,
                                                          Income5GrowthRate,
...
HouseSalaryGrowthMelt <- HouseSalaryGrowth %>% 
  reshape2::melt(id.vars = c("County.Name","LaborRatio","TileSplit","TileSplitInteractive"),
                 measure.vars = c("Income1GrowthRate",
                                  "Income3GrowthRate",
                                  "Income5GrowthRate",
...
HouseSalaryGrowthMelt <- HouseSalaryGrowthMelt %>%
  mutate(Group = case_when(
    variable == "Income1GrowthRate" | variable == "LowHouseGrowthRate" ~ '1',
    variable == "Income3GrowthRate" | variable == "MedHouseGrowthRate" ~ '2',
    variable == "Income5GrowthRate" | variable == "HighHouseGrowthRate" ~ '3',
    TRUE ~ 'NA'
  ),
  Class = case_when(
    variable == "Income1GrowthRate" | 
      variable == "Income3GrowthRate" | 
      variable == "Income5GrowthRate" ~ 'Income',
    variable == "LowHouseGrowthRate" | 
      variable == "MedHouseGrowthRate" | 
      variable == "HighHouseGrowthRate" ~ 'House',
    TRUE ~ 'NA'
  )) %>%
...
IncomeHousePlot <- ggplot(HouseSalaryGrowthMelt, 
                         aes(x = Income, 
                             y = House)) +
  geom_abline(intercept = 0 , slope = 1) +
  geom_point(aes(fill = TileSplitInteractive, 
                 text = paste("County:", 
                              County.Name,                              
                              "\nHouse Price Growth:",
                              percent_function(
             ...
             size = 2,
             alpha = .7) +
  labs(title = "House Price by Income Growth",
       subtitle = "Time: 2014-2019",
       x = "Income Growth",
...
ggplotly(IncomeHousePlot, tooltip = c("text")) %>% 
  layout(legend = list(orientation = "h", x = 0, y = 1))

```

```{r Income growth to rent growth, echo = FALSE, warning = FALSE, message = FALSE, fig.height=6, fig.width=6}
RentSalaryGrowth <- subset(FilteredDataTable, select = c(County.Name, 
                                                          LaborRatio,
                                                          Income1GrowthRate,
                                                          Income3GrowthRate,
                                                          Income5GrowthRate,
...
RentSalaryGrowthMelt <- RentSalaryGrowth %>% 
  reshape2::melt(id.vars = c("County.Name","LaborRatio","TileSplit","TileSplitInteractive"),
                 measure.vars = c("Income1GrowthRate",
                                  "Income3GrowthRate",
                                  "Income5GrowthRate",
...
RentSalaryGrowthMelt <- RentSalaryGrowthMelt %>%
  mutate(Group = case_when(
    variable == "Income1GrowthRate" | variable == "LowRentGrowthRate" ~ '1',
    variable == "Income3GrowthRate" | variable == "MedRentGrowthRate" ~ '2',
    variable == "Income5GrowthRate" | variable == "HighRentGrowthRate" ~ '3',
    TRUE ~ 'NA'
  ),
  Class = case_when(
    variable == "Income1GrowthRate" | 
      variable == "Income3GrowthRate" | 
      variable == "Income5GrowthRate" ~ 'Income',
    variable == "LowRentGrowthRate" | 
      variable == "MedRentGrowthRate" | 
      variable == "HighRentGrowthRate" ~ 'Rent',
    TRUE ~ 'NA'
  )) %>%
  subset(select = -c(variable)) %>%
  spread(Class, value) 
...
IncomeRentPlot <- ggplot(RentSalaryGrowthMelt, 
                         aes(x = Income, 
                             y = Rent)) +
  geom_abline(intercept = 0 , slope = 1) +
  geom_point(aes(fill = TileSplitInteractive, 
             ...
             size = 2,
             alpha = .7) +
  labs(title = "Rent by Income Growth",
       subtitle = "Time: 2014-2019",
       x = "Income Growth",
       y = "Rent Growth") +
  scale_fill_manual(name = NULL,
...
ggplotly(IncomeRentPlot, tooltip = c("text")) %>% 
  layout(legend = list(orientation = "h", x = 0, y = 1))
